...
/**
 * Displays an error state with retry option when calendar fails to load.
 */
export default function FailureState({ onRetry }: FailureStateProps) {
    return (
            ...
            <div className="max-w-2xl w-full">
                ...
                >
                    ...
                    <p className="text-purple-200 mb-4">
                        Looks like there was a problem loading your calendar events.
                    </p>
