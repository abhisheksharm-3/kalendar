...
import { ChevronDown, ChevronUp, X, Calendar as CalendarIcon, Loader2, Zap, Sun, RefreshCw } from 'lucide-react';
...
const LeftSidebar: React.FC<LeftSidebarProps> = ({ date, setDate, onClose }) => {
  const { events, isLoading: eventsLoading, refetchEvents: fetchEvents } = useEvents();
            ...
            {isLoading ? (
              ...
              >
                <div className="flex justify-between items-center mb-2">
                  <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200">KAI Insights</h3>
                  <Button
                    variant="ghost"
                    size="icon"
                    onClick={() => fetchEvents()} // Fetch events when refresh is clicked
